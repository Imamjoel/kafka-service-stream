...
import com.eccomerce.stream.broker.message.FeedbackRatingOneMessage;
...
public class FeedbackRatingOneStream {
    ...
    @Bean
    public KStream<String, FeedbackMessage> kstremFeddbackRating(StreamsBuilder builder) {
...
//        feedbackStream.to("t.commodity.feedback.rating-one",  Produced.with(stringSerde, feedbackRatingOneSerde));
